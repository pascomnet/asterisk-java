...
//            .loadClasses("org.asteriskjava.manager.event", ManagerEvent.class);
    ...
    private void registerBuiltinEventClasses()
    {
		...
		registerEventClass(AuthDetailEvent.class);
		...
		registerEventClass(ConnectEvent.class);
		registerEventClass(ContactListCompleteEvent.class);
		registerEventClass(ContactListEvent.class);
		...
		registerEventClass(DisconnectEvent.class);
		registerEventClass(EndpointList.class);
		registerEventClass(EndpointListComplete.class);
		...
		registerEventClass(OutboundRegistrationDetailCompleteEvent.class);
		registerEventClass(OutboundRegistrationDetailEvent.class);
		...
		registerEventClass(ProtocolIdentifierReceivedEvent.class);
